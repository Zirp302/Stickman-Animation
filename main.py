...
# Значения кнопок для их присвоения переменной keys
keyboard = {
    key.A: "A",
    key.B: "B",
    key.C: "C",
...
texts = {
    ...
    'B': pyglet.text.Label('B', xy['B']['x'] - 5, xy['B']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    'C': pyglet.text.Label('C', xy['C']['x'] - 5, xy['C']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    'D': pyglet.text.Label('D', xy['D']['x'] - 5, xy['D']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    'E': pyglet.text.Label('E', xy['E']['x'] - 5, xy['E']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    'F': pyglet.text.Label('F', xy['F']['x'] - 5, xy['F']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    ...
    'J': pyglet.text.Label('J', xy['J']['x'] - 5, xy['J']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4),
    'K': pyglet.text.Label('K', xy['K']['x'] - 5, xy['K']['y'] - 5, color=(0, 0, 0), batch=pak, group=group4)
    }
